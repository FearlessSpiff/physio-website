...
<template>
  <section id="contact" class="py-24 bg-brand-900 relative overflow-hidden">
    <div class="absolute inset-0 pointer-events-none">
      <div class="absolute bottom-0 right-1/3 w-96 h-96 bg-teal-500/8 rounded-full blur-[120px]" />
    </div>

    <div class="max-w-6xl mx-auto px-6 relative">
      <div class="text-center mb-14">
        <div class="text-teal-400 text-sm font-medium uppercase tracking-widest mb-3">Get in Touch</div>
      ...
      <div class="grid md:grid-cols-5 gap-12 items-start">
        ...
        <div class="md:col-span-2 space-y-6">
          <div
            v-for="item in [
              { icon: '📧', label: 'Email', value: 'hello@physio-lisa.ch' },
          ...
          >
            ...
            <div>
              <div class="text-slate-400 text-xs font-medium uppercase tracking-wide">{{ item.label }}</div>
              <div class="text-white font-medium mt-1">{{ item.value }}</div>
            </div>
          </div>

          <div class="glass-card p-5">
            <div class="text-slate-400 text-xs font-medium uppercase tracking-wide mb-3">Response time</div>
            <p class="text-slate-300/70 text-sm leading-relaxed">
          ...
          <div class="glass-card p-8">
            ...
            >
              <div v-if="status === 'success'" class="text-center py-8">
                ...
                <p class="text-slate-400">We'll be in touch within 24 hours.</p>
