...
<template>
  <section id="about" class="py-24 bg-brand-800 relative overflow-hidden">
    <div class="absolute inset-0 pointer-events-none">
      <div class="absolute top-0 right-0 w-96 h-96 bg-teal-500/10 rounded-full blur-[120px]" />
    </div>
    ...
    <div class="max-w-6xl mx-auto px-6 relative">
      <div class="grid md:grid-cols-2 gap-16 items-center">
        ...
        <div class="relative order-2 md:order-1">
          <div class="glass-card p-2 glow-teal">
            <div class="aspect-[4/5] rounded-xl bg-gradient-to-br from-teal-900/20 to-brand-800 flex items-center justify-center overflow-hidden">
              <img
                v-if="photoUrl()"
                :src="photoUrl()!"
              ...
              <div v-else class="text-center p-8">
                <div class="w-24 h-24 rounded-full bg-teal-500/20 border-2 border-teal-500/40 mx-auto mb-4 flex items-center justify-center">
                  <svg class="w-12 h-12 text-teal-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
                </div>
                <p class="text-slate-500 text-sm">Upload your photo via the admin panel</p>
              </div>
            </div>
          </div>
          <!-- Decorative badge -->
          <div class="absolute -bottom-4 -right-4 glass-card px-5 py-3">
            <div class="text-teal-300 text-xs font-medium">Certified Expert</div>
        ...
        <div class="order-1 md:order-2">
          <div class="text-teal-400 text-sm font-medium uppercase tracking-widest mb-3">About Us</div>
          <h2 class="section-heading mb-6">
            Whole-Body Care,<br />
            <span class="text-gradient">Inside &amp; Out</span>
          </h2>

          <div class="space-y-4 text-slate-300/70 leading-relaxed">
            <p>
          ...
          <div class="mt-8 grid grid-cols-2 gap-4">
            ...
            >
              ...
              <div class="text-slate-400 text-xs mt-1">{{ feature.desc }}</div>
            </div>
          </div>
        </div>
